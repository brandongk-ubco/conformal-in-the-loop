...
python -m confidentaugmentation --model-name=efficientnet-b0 --augmentation-policy-path=./policies/noop.yaml
python -m confidentaugmentation --model-name=efficientnet-b0 --augmentation-policy-path=./policies/noop.yaml --selectively-backpropagate
python -m confidentaugmentation --model-name=efficientnet-b0 --augmentation-policy-path=./policies/noop.yaml --selectively-backpropagate --mapie-alpha 0.05
python -m confidentaugmentation --model-name=efficientnet-b0 --augmentation-policy-path=./policies/noop.yaml --selectively-backpropagate --mapie-alpha 0.03
